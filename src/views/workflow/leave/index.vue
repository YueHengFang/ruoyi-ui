  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="报销类型" prop="type">
        <el-select v-model="queryParams.type" placeholder="请选择报销类型" clearable size="small">
          <el-option
    ...
    <el-table v-loading="loading" :data="leaveList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="报销事由" align="center" prop="title"/>
      <el-table-column label="费用类型" align="center" prop="reason"/>
      <el-table-column label="发生时间" align="center" prop="leaveStartTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.leaveStartTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="费用金额" align="center" prop="leaveEndTime" width="180">
        <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="报销类型" prop="type">
          <el-select v-model="form.type" placeholder="请选择报销类型" @change="chooseMedicine">
            <el-option
              v-for="dict in typeOptions"
              :key="dict.dictValue"
              :label="dict.dictLabel"
        ...
        <el-form-item label="发生时间" prop="leaveStartTime">
          <el-date-picker clearable size="small" style="width: 200px"
        ...
        <el-form-item label="费用金额" prop="leaveEndTime">
          <el-date-picker clearable size="small" style="width: 200px"
    ...
    <sop-add ref="sopAddRef" :visible="isSopAddView"   :sopData="sopData"   @close-callback="closeCallback"/>
  </div>

</template>

<script>
  import sopAdd from '@/components/sop/sopAdd'
  ...
  export default {
    name: 'Leave',
    components: {leaveHistoryForm,sopAdd},
    data() {
      return {
        sopData:[],
        modelVisible: false,
    ...
    methods: {
      ...
      historyFory(row) {
        ...
        this.isSopAddView = true;
   
        historyFromData(row.id).then(response => {
